      ...
      <section className="bg-gradient-to-br from-sky-50 to-white">
        <div className="section-container text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6 leading-tight">
            あなたのスキルを、
            <br />
            <span style={{ color: 'var(--primary)' }}>正しく評価してくれる職場へ</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() =>
                setToast({ message: '準備中です。メールでご登録ください。', type: 'info' })
              }
              className="inline-flex items-center justify-center px-8 py-4 bg-[#06C755] text-white font-bold rounded-lg transition-all hover:opacity-90 active:scale-95 text-lg"
            >
              LINEで登録する
            </button>
          </div>
