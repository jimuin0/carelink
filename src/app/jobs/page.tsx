...
const faqItems = [
  {
    question: '登録は無料ですか？',
    answer: 'はい、登録から求人紹介・応募まで、すべて完全無料です。費用が発生することは一切ありません。',
  },
  {
    question: '在職中でも登録できますか？',
    answer: 'はい、在職中の方も登録いただけます。「まずは情報収集だけ」という方も歓迎です。転職のタイミングが決まっていなくても、条件に合った求人を見逃さずにチェックできます。',
  },
  {
    question: '個人情報はどう管理されますか？',
    answer: 'SSL暗号化通信で情報を保護し、個人情報保護法に基づいて厳重に管理しています。ご登録情報が許可なく施設に公開されることはありません。',
  },
  {
    question: '希望に合わない求人を紹介されませんか？',
    answer: 'ご登録時の希望条件（職種・勤務地・給与など）をもとに、マッチする求人のみをご紹介します。条件はいつでも変更可能です。',
  },
  {
    question: '退会はできますか？',
    answer: 'はい、いつでも退会可能です。退会後はすべての登録データを速やかに削除いたします。違約金等は一切かかりません。',
  },
];
      ...
      <section className="bg-gradient-to-br from-sky-50 to-white">
        <div className="section-container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <p className="text-gray-400 text-sm">LINE登録は近日公開予定です</p>
          </div>
        </div>
      </section>
