...
export default function CronMonitorPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-6">
      <SbPageHeader title="Cron実行監視" actions={<button type="button" onClick={load} className="text-sm px-3 py-1.5 bg-sky-100 text-sky-700 rounded-lg hover:bg-sky-200 transition-colors">更新</button>} />
