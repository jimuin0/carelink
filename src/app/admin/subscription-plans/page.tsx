...
export default function SubscriptionPlansPage() {
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <SbPageHeader title="月額プラン" description="サブスクリプション定義と契約者管理" actions={tab === 'plans' && <button type="button" onClick={() => setShowForm(true)} className="btn-primary text-sm !px-4 !py-1.5">+ 新規プラン</button>} />
