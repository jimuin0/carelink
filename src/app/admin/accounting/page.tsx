  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 space-y-5">
        ...
        {/* エクスポートボタン */}
        <button onClick={handleExport} disabled={!facilityId}
          className="w-full py-3 bg-sky-500 text-white rounded-xl font-medium hover:bg-sky-600 disabled:opacity-50 flex items-center justify-center gap-2">
