...
export default function AdminFeaturesPage() {
  ...
  return (
    <div>
      <SbPageHeader title="特集管理" actions={<button type="button" onClick={() => setEditForm({ ...emptyForm, sort_order: features.length.toString() })} className="btn-primary px-5 !py-2.5">特集を追加</button>} />
