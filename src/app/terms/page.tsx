      ...
      <div className="max-w-3xl mx-auto prose prose-gray">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600">
            本サービスは、医療・福祉・美容業界に特化した採用×集客プラットフォームです。施設・サロンの集客支援および求職者の転職支援を目的として、施設情報の掲載、求人情報の掲載、求職者の登録等の機能を提供します。
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-1">
            ...
            <li>本サービスを通じて行われた施設と求職者間の雇用契約・取引等について、当事業者は一切の責任を負いません。</li>
