 ...
 *
 * majorCities（トップページ下部の主要都市クイックリンク）の各エントリが
 ...
 */
import { majorCities } from '../HomeBelowFold';
import { isValidCitySlug } from '@/data/city-slugs';

describe('HomeBelowFold majorCities', () => {
  test.each(majorCities)('$pref/$slug（$name）は city-slugs.ts に実在する', ({ pref, slug }) => {
