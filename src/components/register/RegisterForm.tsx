  ...
  return (
    <div className="mx-auto max-w-[640px] sm:px-12">
      <div>
        ...
        <form onSubmit={handleSubmit(() => setShowConfirm(true))} onChange={handleFieldChange} noValidate className="border-y border-[#E6DCCD] bg-[#FFFCF9] px-5 py-7 sm:border sm:px-10 sm:py-10">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <details className="group border border-[#E6DCCD] bg-[#F7F3EC]/70 px-4 py-3">
                <summary className="cursor-pointer list-none text-xs font-medium text-[#6F655C] marker:content-none">
                  <span className="inline-flex items-center gap-1.5">
                    <span className="text-base leading-none text-[#A8998B] transition-transform group-open:rotate-45">+</span>
                    直通電話・Webサイトを追加する
                  </span>
                </summary>
